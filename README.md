...
- Дневник (Жилетка / Друг с битой / Пледик / Подружка): [prompts/dnevnik-prompt.md](prompts/dnevnik-prompt.md) — локальная копия, источник Google Docs: https://docs.google.com/document/d/1uhe0DLEdSUQEARvXzrpvEOYtYQ6-p1AT7M7R8mii4R0/edit. Пересмотрен 28.08.2026 — добавлена роль «Подружка», лексикон вынесен отдельно (см. ниже).
...
- При запуске читать (обновлено 28.08.2026): README → LPF-регламент (раздел «Правила несмешивания» и «Episteme-карточки») → [docs/otnosheniya-pravila.md](docs/otnosheniya-pravila.md) (правила коммуникации с конкретными людьми — нужны сразу, не только когда всплывёт имя) → промпт ветки → живой лексикон. Затем запроси у Марии телеметрию (сон, энергия, ёмкость, контекст дня, было ли отключение Дневника из-за технических проблем и когда).
