...
- Дневник (Жилетка / Друг с битой / Пледик / Подружка): [prompts/dnevnik-prompt.md](prompts/dnevnik-prompt.md) — локальная копия, источник Google Docs: https://docs.google.com/document/d/1uhe0DLEdSUQEARvXzrpvEOYtYQ6-p1AT7M7R8mii4R0/edit. Пересмотрен 28.08.2026 — добавлена роль «Подружка», лексикон вынесен отдельно (см. ниже), расширен список чтения при старте дня, добавлен раздел PEOPLE INTAKE (расспрашивать о людях по ходу разговора и раскладывать в факты/кандидаты правил).
...
- При запуске читать, в этом порядке (обновлено 28.08.2026):
  ...
  4. [docs/o-marii-fakty-lyudi.md](docs/o-marii-fakty-lyudi.md) — факты о людях в жизни Марии, чтобы не переспрашивать то, что уже известно
  5. **Вчерашняя запись в [telemetry/diary-2026-08.md](telemetry/diary-2026-08.md)** — эмоциональный фон и триггеры вчерашнего дня, чтобы не начинать разговор с чистого листа
  6. Промпт ветки
  7. Живой лексикон
